...
export default async function Page() {
  ...
  return (
    <Container
      as={"main"}
      className={
        "flex flex-col gap-5 py-5 md:flex-row-reverse md:justify-between"
      }
    >
      ...
      <div className={"md:w-[50%] flex flex-col gap-5"}>
        ...
        <Link
          ...
          className={
            "flex items-center justify-center gap-1 px-5 py-4 font-semibold text-orange-500" +
            " transition-colors rounded md duration-600 hover:bg-orange-950"
          }
        >
